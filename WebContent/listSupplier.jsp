		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">List Supplier</h1>
						...
						<div class="card-body">
							<table id="datatablesSimple">
								<tr>
									...
									<th class="text-center">SUPPLIER POSITION</th>
								...
								<c:forEach items="${supp}" var="s">
									<tr>
										<td><a
											href="ViewSupplierController?id=<c:out value="${s.supplierID}" />"><c:out
													value="${s.supplierID}" /></a></td>
										<td><c:out value="${s.supplierName}" /></td>
										<td><c:out value="${s.supplierPosition}" /></td>
