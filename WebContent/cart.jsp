    ...
    <body class="sb-nav-fixed">
        ...
        <div class="col-12">
            <div class="table-responsive">
			 ...
			 <td  class="text-center"><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${c.productprice}"/></td>
			 ...
			 <td>			
								...
								<a class="inc-dec" href="quantity-inc-dec?action=dec&productid=${c.productid}">
								<i class="fas fa-minus-square"></i>
								</a>
								<div class="col-sm-3 mr-2 ml-2">
								<input type="number" name="quantity" class="form-control" value="${c.productquantity}" readonly> 
							  </div>
								<a class="inc-dec" href="quantity-inc-dec?action=inc&productid=${c.productid}">
        ...
        <div class="col mb-2 ">
            <div class="row  d-flex justify-content-center">
                <div class="col-sm-5  col-md-2">
                   <a href="viewProductController"><button class="btn btn-block btn-light">Continue Shopping</button></a> 
                </div>
