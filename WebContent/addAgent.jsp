  ...
  <body class="sb-nav-fixed">
          ...
          <div class="container-fluid px-4">
            ...
            <input type="hidden" name="adminID" value="<%=sessionid %>"/>
              <div class="form-group row">
                ...
                >
                <div class="col-sm-4">
                 <input type="text" class="form-control" id="inputPassword" placeholder="Enter Agent ID" name="agentID"  required>
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-4">
                 <input type="text" class="form-control" id="inputPassword" placeholder="Enter Agent Name" name="agentName"  required>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-4">
                <input  type="password"class="form-control" id="password" name="agentPassword" placeholder="Enter Password"  required> 
    ...
    Show Password
       ...
       <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                   <select class="form-control" name="agentGender" id="productType" required>
      ...
      <option value="Dry" >Male</option>
		<option value="Wet">Female</option>
               ...
               <div class="form-group row" >
                ...
                >
                <div class="col-sm-4">
                <input type="text" class="form-control" id="inputPassword" name="agentPhoneNo" placeholder="Enter Phone Number" required>
               ...
               <div class="form-group row" >
                ...
                >
                <div class="col-sm-4">
                <textarea  class="form-control" id="rm_input" name="agentAddress" rows="3"   required></textarea>
              ...
              <div class="form-group row" >
                ...
                >
                <div class="col-sm-4">
                <input type="email" class="form-control" id="rm_input" name="agentEmail" placeholder="Enter Email Address" required>
              ...
              <div class="form-group row" >
                ...
                >
                <div class="col-sm-2">
                <input type="date" class="form-control" id="rm_input" name="agentDateAssign"  required>
