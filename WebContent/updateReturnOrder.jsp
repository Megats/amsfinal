...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="home">
    <h1 class="w3-jumbo"><b>Update Return Order</b></h1>
...
<form action="UpdateReturnOrderController" method="post">
	Return order id<br>
	<input name="returnOrderId" type="text" value="${ro.returnOrderId}" readonly><br>
	Return order quantity<br>
	<input name="returnOrderQuantity" type="text" value="${ro.returnOrderQuantity}" readonly><br>
	Return order status<br>
	<select name="returnOrderStatus">
		<option value="Not approved yet" selected>Not approved yet</option>
		<option value="Approved">Approved</option>
		<option value="Rejected">Rejected</option>
	</select><br><br>
	Return order description<br>
	<input name="returnOrderDescription" type="text" value="${ro.returnOrderDescription}" readonly><br>
	Order id<br>
	<input name="orderId" type="text" value="${ro.orderId}" readonly><br>
