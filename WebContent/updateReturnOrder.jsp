      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Update Return Order</h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item active">Dashboard</li>
            </ol>
            <form action= "UpdateReturnOrderController" method="post">
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                  >Return Order ID:</label
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control" id="inputPassword" name="returnOrderId" value="<c:out value="${ro.returnOrderId}"/>" readonly>
                </div>
              </div>
               <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control" id="inputPassword" name="orderId" value="<c:out value="${ro.orderId}"/>" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-2">
             <input type="text" class="form-control" id="inputPassword" name="returnOrderQuantity" value="<c:out value="${ro.returnOrderQuantity}"/>" readonly>
		    ...
		    <option value="Rejected">Rejected</option>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-3">
                <textarea class="form-control" id="inputPassword" name="returnOrderDescription"  rows="3"readonly> <c:out value="${ro.returnOrderDescription}"/> </textarea>  
