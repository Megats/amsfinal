...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="home">
	...
	<form action="updateProductController" method="post">
		...
		(Current product quantity: <c:out value="${p.productQuantity}"/>)
		
		<br><br><input type="hidden" name="productid" value="<c:out value="${p.productId}"/>">
		Product Name<br>
		<input type="text" name="productName" value="${p.productName}" readonly><br>
		Total Product Quantity Added:<br>
		<input type="number" name="productQuantity"><br>
		Product Price<br>
		<input type="text" name="productPrice" value="${p.productPrice}" readonly><br><br>
