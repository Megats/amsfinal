          ...
          <div class="container-fluid px-4">
            ...
            <form action= "updateProductController" method="post">
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control" id="inputPassword" name="productid" value="<c:out value="${p.productId}"/>" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                  >Current Product Quantity:</label
                >
                <div class="col-sm-2">
             <input type="text" class="form-control" id="inputPassword" name="productQuantity" value="<c:out value="${p.productQuantity}"/>" readonly>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-3">
                <input type="text" class="form-control" id="inputPassword" name="productName" value="<c:out value="${p.productName}"/>" readonly >  
               ...
               <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                <input type="text" class="form-control" id="inputPassword" name="productPrice" value="RM<fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${p.productPrice}"/>
            " readonly >  
