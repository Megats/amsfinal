...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <!-- Header -->
  <div class="w3-container" style="margin-top:20px" id="home"><h3>PAYMENT LIST</h3>
...
<table>
 ...
 <tr>
 	...
 	<td>
 	<c:choose> 
 	<c:when test="${p.paymentbank.equalsIgnoreCase('NONE')}">
 		No image
 	</c:when>
 	<c:otherwise>
 		<a href="displayImageController?id=${p.paymentid}" download>Receipt.jpg</a>
    </c:otherwise>
    </c:choose>
    <td><c:out value="${p.paymentbank}" /></center></td> 
    <td><c:out value="${p.paymentstatus}" /></center></td> 
    <td><a href="ChangeStatusController?id=${p.paymentid}">Update</a></td>
</tr></c:forEach>
