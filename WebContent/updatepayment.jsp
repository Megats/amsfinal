  ...
  <body class="sb-nav-fixed">
            ...
            <form action="UpdatePaymentController" method="post" enctype="multipart/form-data">
             <input type="hidden" name="id" value="<%=paymentid%>">
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                   <select class="form-control" id="exampleFormControlSelect1" name="bank" required>
    ...
    <option value="Bank Islam">Bank Islam</option>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-3">
            <input type="file" class="form-control" id="inputPassword" name="receipt" required>  
               
                </div>
              </div>
             
             <button type="submit" class="btn btn-outline-dark mt-2">Update Payment</button>
