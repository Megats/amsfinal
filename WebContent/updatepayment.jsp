		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<form action="UpdatePaymentController" method="post"
						enctype="multipart/form-data">
						<input type="hidden" name="id" value="<%=paymentid%>"> <input
							type="hidden" name="agentid" value="<%=agentid %>">
						...
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Upload
								Receipt:</label>
							<div class="col-sm-3">
						...
						<button type="submit" class="btn btn-outline-dark mt-2">Update
							Payment</button>
						<div
