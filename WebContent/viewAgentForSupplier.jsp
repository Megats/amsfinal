		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Update Agent Information</h1>
					...
					<form action="UpdateAgentController" method="post">
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control-plaintext"
									id="inputPassword" name="agentId"
									value="<c:out value="${a.agentid}"/>" readonly>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control-plaintext"
									...
									value="<c:out value="${a.agentname}"/>" readonly>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control-plaintext"
									...
									value="<c:out value="${a.agentgender}"/>" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control-plaintext"
									...
									value="<c:out value="${a.agentphoneno}"/>" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control-plaintext"
									id="inputPassword" name="agentAddress"
									value="${a.agentaddress}" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control-plaintext"
									id="inputPassword" name="agentEmail"
									value="<c:out value="${a.agentemail}"/>" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="date" class="form-control-plaintext"
									id="inputPassword" name="agentDateAssign"
									value="<c:out value="${a.agentDateAssign}"/>" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control-plaintext"
									id="inputPassword" name="agentDateAssign"
									value="<c:out value="${a.agentstatus}"/>" readonly>
