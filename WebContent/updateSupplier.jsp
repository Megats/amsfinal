...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="home">
    <h1 class="w3-jumbo"><b>Update Supplier</b></h1>
...
<form action="UpdateSupplierController" method="post">
  ...
  <c:out value="${s.supplierID}"/><br>
  <input type="hidden" name="supplierID" value="<c:out value="${s.supplierID}"/>">
  
  <label for="supplierName">Full name:</label><br>
  <input type="text" id="supplierName" name="supplierName"  value="<c:out value="${s.supplierName}"/>" ><br>
  
  <label for="supplierPosition">Position:</label>
  <c:out value="${s.supplierPosition}"/><br>
  
  <label for="agentPassword">Password:</label><br>
  <input type="text" id="agentPassword" name="supplierPassword"  value="<c:out value="${s.supplierPassword}"/>" ><br>
  <br><br>
