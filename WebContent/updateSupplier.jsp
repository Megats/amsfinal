  ...
  <body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
      ...
      <div id="layoutSidenav_content">
          ...
          <div class="container-fluid px-4">
            ...
            <form action= "UpdateSupplierController" method="post">
              <div class="form-group row">
                ...
                >
                <div class="col-sm-3">
                 <input type="text" class="form-control" id="inputPassword" name="supplierID" value="<c:out value="${s.supplierID}"/>" readonly>
                </div>
              </div>
               <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-3">
                 <input type="text" class="form-control" id="inputPassword" name="supplierName" value="<c:out value="${s.supplierName}"/>" >
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-3">
             <input type="text" class="form-control" id="inputPassword" name="supplierPosition" value="<c:out value="${s.supplierPosition}"/>" readonly>
               ...
               <div class="form-group row">
                ...
                >
                <div class="col-sm-3">
             <input type="text" class="form-control" id="inputPassword" name="supplierPassword" value="<c:out value="${s.supplierPassword}"/>">
        ...
        <strong>Success!</strong> Information has been successfully updated.
