									...
									<div class="card-border">
										...
										<div class="card-body" style="height: 50%; color: black;">
											...
											<c:if test="${p.productQuantity >= 1}">
												<a href="CustomerBuyNowController?id=${p.productId}"><button
														class="btn btn-info" onclick="showAlertSuccessfulAdd()">Buy
														Now</button></a>
												<a href="CustomerAddCartController?id=${p.productId}"><button
														class="btn btn-info" onclick="alert()">Add To
														Cart</button></a>
