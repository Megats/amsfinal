				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Payment Table
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								...
								<tbody>
									...
									<tr>
										<td><a
											href="ReceiptController?id=<c:out value="${pm.orderid}"/>"><c:out
													value="${pm.paymentid}" /></a></td>
										<td><c:out value="${pm.paymentdate}" /></td>
										<td><c:out value="${pm.paymentbank}" /></td>
										<td><c:out value="${pm.paymentstatus}" /></td>

										<td class="text-center"><a
											href="updatepayment.jsp?id=<c:out value="${pm.paymentid}" />"><i
