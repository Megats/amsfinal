...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="home">
    <h1 class="w3-jumbo"><b>View Payment</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
  </div>
<a href="ViewPaymentController"></a>
<table>
  <tr>
    <th>Payment ID</th>
    <th>Payment Date</th>
 ...
 <tr>
 	<td><a href="ReceiptController?id=<c:out value="${pm.orderid}"/>"><c:out value="${pm.paymentid}" /></a></td>
 	<td><c:out value="${pm.paymentdate}" /></td>
    <td><c:out value="${pm.paymentbank}" /></td>
    <td><c:out value="${pm.paymentstatus}"/></td> 
    <td><a href="updatepayment.jsp?id=<c:out value="${pm.paymentid}" />">Update</a></td>
