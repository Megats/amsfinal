          ...
          <div class="container-fluid px-4">
            ...
            <form action= "UpdateStatusController" method="post">
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control" id="inputPassword" name="paymentid" value="<c:out value="${pm.paymentid}"/>" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-2">
             <input type="text" class="form-control" id="inputPassword" name="orderid" value="<c:out value="${pm.orderid}"/>" readonly>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                <input type="text" class="form-control" id="inputPassword" name="bank" value="<c:out value="${pm.paymentbank}"/>" readonly >  
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  ...
                  <option value="${pm.paymentstatus}" selected disabled><c:out value="${pm.paymentstatus}"/></option>
