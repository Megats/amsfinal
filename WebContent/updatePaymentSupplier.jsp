...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
 ...
 <!-- Header -->
  <div class="w3-container" style="margin-top:20px" id="home">
    <h1 class="w3-jumbo"><b>Update Payment</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
  </div>
...
<form action="UpdateStatusController" method="post">
	<b>Payment Id:</b>
	<c:out value="${pm.paymentid}"/><br><input type="hidden" name="paymentid" value="<c:out value="${pm.paymentid}"/>">
	<b>Order Id:</b>
	<c:out value="${pm.orderid}"/><br><br><input type="hidden" name="orderid" value="<c:out value="${pm.orderid}"/>">
	<p><b>Bank: </b>
	<c:out value="${pm.paymentbank}"/><br><br><input type="hidden" name="bank" value="<c:out value="${pm.paymentbank}"/>">
