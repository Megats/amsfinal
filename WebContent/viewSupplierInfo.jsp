...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="home">
    <h1 class="w3-jumbo"><b>View Supplier Info</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
  </div>

<label for="supplierID"><b>Supplier ID: </b></label><c:out value="${s.supplierID}"/>
<br><br>
<label for="supplierName"><b>Supplier Name: </b></label><c:out value="${s.supplierName}"/>
<br><br>
<label for="supplierPassword"><b>Supplier Password: </b></label><c:out value="${s.supplierPassword}"/>
<br><br>
<label for="supplierPosition"><b>Supplier Position: </b></label><c:out value="${s.supplierPosition}"/>
<br><br>
<label for="adminID"><b>Admin ID: </b></label><c:out value="${s.adminID}"/><br>
<a href="UpdateSupplierController?id=<c:out value="${s.supplierID}" />">Update</a>
<br><br>
