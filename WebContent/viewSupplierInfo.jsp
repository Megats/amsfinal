      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">View Supplier Information</h1>
            ...
            <form >
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control-plaintext" id="inputPassword" name="supplierId" value="<c:out value="${s.supplierID}"/>" readonly>
                </div>
              </div>
               <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control-plaintext" id="inputPassword" name="agentName" value="<c:out value="${s.supplierName}"/>" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-2">
             <input type="text" class="form-control-plaintext" id="inputPassword" name="agentGender" value="<c:out value="${s.supplierPassword}"/>" readonly>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control-plaintext" id="inputPassword" name="agentPhoneNo" value="<c:out value="${s.supplierPosition}"/>" readonly>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
                 <input type="text" class="form-control-plaintext" id="inputPassword" name="agentPhoneNo" value="<c:out value="${s.adminID}"/>" readonly>
               
                </div>
              </div>
               </form>
                   <a href="UpdateSupplierController?id=<c:out value="${s.supplierID}" />"><button class="btn btn-outline-dark mt-2 ">Update Information</button></a>
