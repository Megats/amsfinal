...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:20px" id="home">
    <h1 class="w3-jumbo"><b>Create Supplier</b></h1>
...
<form action="AddSupplierController" method="post">
  ...
  <input type="text" id="supplierID" name="supplierID"><br>
  
  <label for="supplierName">Full name:</label><br>
  <input type="text" id="supplierName" name="supplierName"><br><br>
  Supplier Position:
  <select name="supplierPosition">
  			<option value="supplier">Supplier</option>
  </select><br><br>
  
  <label for="supplierPassword">Password:</label><br>
  <input type="text" id="supplierPassword" name="supplierPassword"><br>
  <br><br>
