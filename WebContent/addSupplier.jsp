          ...
          <div class="container-fluid px-4">
            ...
            <input type="hidden" name="adminId" value="<%=sessionid %>"/>
              <div class="form-group row">
                ...
                >
                <div class="col-sm-4">
                 <input type="text" class="form-control" id="inputPassword" placeholder="Enter Supplier ID" name="supplierID"  required>
                </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                >
                <div class="col-sm-4">
                 <input type="text" class="form-control" id="inputPassword" placeholder="Enter Supplier Name" name="supplierName"  required>
               ...
               <div class="form-group row" >
                ...
                >
                <div class="col-sm-4">
                <input type="text" class="form-control" id="inputPassword" name="supplierPosition" value="supplier" readonly>
              ...
              <div class="form-group row">
                ...
                >
                <div class="col-sm-4">
                <input  type="password"class="form-control" id="password" name="supplierPassword" placeholder="Enter Password"  required> 
