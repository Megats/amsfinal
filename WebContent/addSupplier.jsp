				...
				<div class="container-fluid px-4">
					...
					<form action="AddSupplierController" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="inputPassword"
									placeholder="Enter Supplier ID" name="supplierID" required>
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="inputPassword"
									name="supplierPosition" value="supplier" readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="password" class="form-control" id="password"
									name="supplierPassword" placeholder="Enter Password" required>
