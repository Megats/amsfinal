					...
					<form>
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Agent
								ID:</label>
							<div class="col-sm-6">
								<label for="staticEmail" class="col-sm-5 col-form-label"><c:out
										value="${a.agentid}" /></label>
							</div>
						</div>
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Agent
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<label for="staticEmail" class="col-sm-5 col-form-label"><c:out
										value="${a.agentstatus}" /></label>
							</div>
						</div>
						<a href="UpdateAgentPersonalInformationController?id=${a.agentid}">
