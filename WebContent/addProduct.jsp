...
<input type="hidden" name="supplierid" value="<%=sessionid %>"/>
	...
	<select id="productType" name="productType">
		<option value="default" selected>Enter product type</option>
		<option value="Dry" >Dry</option>
		<option value="Wet">Wet</option>
	</select>
	<div id="drysection" style="display: none">
	Enter type of product<br>
	<input type="text" name="type" ><br>
	Enter weight of product<br>
	<input type="text" name="weight" ><br>
	</div>
	<div id="wetsection" style="display: none">
	Enter flavor of product<br>
	<input type="text" name="flavour" ><br>
	Enter volume of product<br>
	<input type="text" name="volume" ><br>
	</div>
	<div>
	  <label for="load-file">Insert product picture</label>
