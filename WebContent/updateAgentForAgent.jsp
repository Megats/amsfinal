		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<form action="UpdateAgentPersonalInformationController"
						method="post">
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" id="inputPassword"
									name="agentID" value="<c:out value="${a.agentid}"/>" readonly>
							</div>
						</div>
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Agent
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inputPassword"
									name="agentName" value="<c:out value="${a.agentname}"/>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" id="inputPassword"
									name="agentGender" value="<c:out value="${a.agentgender}"/>"
									readonly>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inputPassword"
									name="agentPhoneNo" value="<c:out value="${a.agentphoneno}"/>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inputPassword"
									name="agentEmail" value="<c:out value="${a.agentemail}"/>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<textarea class="form-control" name="agentAddress"
									id="exampleFormControlTextarea1" rows="3"><c:out
										value="${a.agentaddress}" /></textarea>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" id="inputPassword"
									name="agentStatus" value="<c:out value="${a.agentstatus}"/>"
									readonly>
