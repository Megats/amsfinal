...
<form action="UpdateAgentPersonalInformationController" method="post">
  
  <label for="agentID">Agent ID:</label><br>
  <c:out value="${a.agentid}"/>
  <input type="hidden" id="agentID" name="agentID" value="<c:out value="${a.agentid}"/>"readonly/><br>
  
  <label for="agentName">Full name:</label><br>
  <input type="text" id="agentName" name="agentName" value="<c:out value="${a.agentname}"/>"/><br>
  
  <label for="agentGender">Gender:</label><br>
  <c:out value="${a.agentgender}"/>
  <input type="hidden" id="agentGender" name="agentGender" value="<c:out value="${a.agentgender}"/>"readonly/><br>
	
  <label for="agentPhoneNo">Phone number:</label><br>
  <input type="text" id="agentPhoneNo" name="agentPhoneNo" value="<c:out value="${a.agentphoneno}"/>"/><br>
  
  <label for="agentAddress">Address:</label><br>
  <textarea id="agentAddress" name="agentAddress" /><c:out value="${a.agentaddress}"/></textarea><br>
  
  <label for="agentEmail">Email address:</label><br>
  <input type="text" id="agentEmail" name="agentEmail" value="<c:out value="${a.agentemail}"/>"/><br>
  
  <label for="agentDateAssign">Date Assigned:</label><br>
  <c:out value="${a.agentDateAssign}"/>
  <input type="hidden" id="agentDateAssign" name="agentDateAssign" value="<c:out value="${a.agentDateAssign}"/>"readonly/><br>
   <label for="agentStatus">Agent Status:</label><br>
  <c:out value="${a.agentstatus}"/>
  <input type="hidden" id="agentStatus" name="agentstatus" value="<c:out value="${a.agentstatus}"/>" readonly/>
	<br><br>
  <input type="submit" value="Update">  <span style="color:red;" id="success">${success} </span>
