				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Order Details Table
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								...
								<c:forEach items="${roList}" var="ro">
									<tr>
										...
										<td><c:set var="totalprice"
												value="${totalprice+ro.productPrice*ro.cart.productquantity}" />
								...
								<tr>
									...
									<th>RM<c:out value="${od.ordertotalprice}" />0
									</th>
					...
					<form action="UpdateOrderController" method="post">
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Order
								ID:</label>
							<div class="col-sm-2">
								<input class="form-control" name="orderid" value="${od.orderid}"
									readonly>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<select name="status" class="form-control"
									<c:if test="${od.paymentstatus.equals('Payment Pending')}"><c:out value="disabled='disabled'"/></c:if>>
									<option value="${od.orderstatus}" selected disabled><c:out
											value="${od.orderstatus}" /></option>
						...
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Order
								Status</label>
							<div class="col-sm-3">
								<label for="staticEmail" class="col-sm-2 col-form-label label"><c:out
										value="${od.orderstatus}" /></label>
							</div>
						</div>
						<div class="form-group row">
							<label for="staticEmail" class="col-sm-2 col-form-label label">Payment
								Status</label>
							<div class="col-sm-4">
								<label for="staticEmail" class="col-sm-4 col-form-label label"><c:out
										value="${od.paymentstatus}" /></label>
							</div>
						</div>
