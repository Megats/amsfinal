...
<tr>
           ...
           <div class="form-group row">
                ...
                >
                <div class="col-sm-2">
               <input class="form-control" name="orderid" value="${od.orderid}" readonly >
              </div>
              </div>
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label label"
                ...
                <option value="${od.orderstatus}" selected disabled><c:out value="${od.orderstatus}"/></option>
		    ...
		    <option value="Rejected">Rejected</option>
                ...
                <div class="col-sm-3">
                 <label for="staticEmail" class="col-sm-2 col-form-label label"
                  ><c:out value="${od.orderstatus}"/></label
                >
                </div>
              </div>
                <div class="form-group row">
                ...
                <label for="staticEmail" class="col-sm-4 col-form-label label"
                  ><c:out value="${od.paymentstatus}"/></label>
                </div>
              </div>
