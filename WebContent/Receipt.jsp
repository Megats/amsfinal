					...
					<div class="agileinfo-ads-display col-md-13 ">
						<div class="wrapper center">
							...
							<div class="product-sec2" id="print">
								<p align="center" style="color: #000000;">Your order will be
									ready after our representative validate your payment.</p>
								<p align="center" style="color: #000000;">Thank you for
									Shopping with us!</p>
								<div class="table-responsive">
									...
									<p style="color: #575757;">
										<b>Payment ID:</b>
										<c:out value="${od.paymentid}" />
									<p style="color: #575757;">
										<b>Name:</b>
										<c:out value="${od.agentname}" />
									<p style="color: #575757;">
										<b>Address:</b>
										<c:out value="${od.agentaddress}" />
									<p style="color: #575757;">
										<b>Phone No:</b>
										<c:out value="${od.agentphoneno}" />
