...
<html lang="en">
  ...
  <tr>
    ...
    <th class="text-center">RETURN ORDER QUANTITY</th>
    <th class="text-center">RETURN ORDER STATUS</th>
    <th class="text-center">RETURN ORDER IMAGE</th>
    <th class="text-center">RETURN ORDER DESCRIPTION</th>
 ...
 <c:forEach items="${roList}" var="ro">
	<tr>
		...
		<td><img src="data:image/jpg;base64,${ro.base64Image}" width="80" height="80"/></td>
		<td><c:out value="${ro.returnOrderDescription}" /></td>
		<td><c:out value="${ro.orderId}" /></td>
		<td class="text-center"><a href="UpdateReturnOrderController?returnOrderId=<c:out value="${ro.returnOrderId}" />"><i class="fas fa-pen-alt" title="Update"></i></a></td>
	</tr>
	</c:forEach>
</table>
