							...
							<table id="datatablesSimple">
								...
								<tbody>
									<c:forEach items="${od}" var="o">
										<tr>
											<td><a
												href="ListProductController?id=<c:out
                            value="${o.orderid}"
                          />"><c:out
														value="${o.orderid}" /></td>
											...
											<td><a
												href="ViewPaymentController?id=<c:out
                            value="${o.paymentid}"
                          />"><c:out
														value="${o.paymentid}" /></td>
											<td><c:out value="${o.paymentstatus}" /></td>
											<td><c:if
													test="${o.paymentstatus.equals('Payment Rejected')}">
													<a
														href="DeleteOrderController?id=${o.orderid}&agentid=<%= agentid %>">Delete</a>
												</c:if></td>
										</tr>
									</c:forEach>
								</tbody>
