					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="ListOrderController">View Order</a> <a
									class="nav-link" href="ListPaymentController">View Payment</a>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">List Agent</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item active">Dashboard</li>
					</ol>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Payment List Table
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								...
								<c:forEach items="${agent}" var="a">
									<tr>
										<td><a
											href="viewAgentForSupplierController?id=<c:out value="${a.agentid}" />"><c:out
													value="${a.agentid}" /></a></td>
										<td><c:out value="${a.agentname}" /></td>
										<td><c:out value="${a.agentstatus}" /></td>
										<td class="text-center"><a
											href="UpdateAgentController?id=<c:out value="${a.agentid}" />"><i
												class="fas fa-pen-alt" title="Update"></i></a></td>
									</tr>
								</c:forEach>
							</table>
						</div>
				...
				<div class="p-4">
					<div class="py-5 text-center">
						<div id="month_chart" class="m-5"
							style="width: 80%; height: 350px; margin: 0 auto; display: inline-block;"></div>
